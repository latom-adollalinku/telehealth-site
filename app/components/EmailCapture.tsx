...
export default function EmailCapture({
 ...
 required
 className="flex-1 min-w-0 px-4 py-3 bg-surface border border-line text-ink placeholder-gray-500 rounded text-sm"
 />
 <button
 type="submit"
 disabled={loading}
 className="px-6 py-3 bg-accent text-[color:var(--on-accent)] font-semibold text-sm rounded hover:bg-accent-hover transition-colors whitespace-nowrap disabled:opacity-60"
 >
 ...
 className="w-full px-4 py-3 bg-surface border border-line text-ink placeholder-gray-500 rounded text-sm"
 />
 </div>
 <div>
 ...
 type="submit"
 disabled={loading}
 className="w-full py-3 bg-accent text-[color:var(--on-accent)] font-semibold text-sm rounded hover:bg-accent-hover transition-colors disabled:opacity-60"
 >
