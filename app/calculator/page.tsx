...
export default function DosingGuidePage() {
 ...
 {/* Medication Picker */}
 <div className="mb-10">
 <p className="text-sm font-semibold text-accent mb-4 tracking-widest uppercase">
 ...
 selectedId === m.id
 ? 'border-accent bg-gradient-to-br ' + m.color + ' shadow-lg'
 : 'border-line bg-surface hover:border-accent/50'
 }`}
 >
 <div className="text-lg font-bold text-ink mb-1">{m.name}</div>
 <div className="text-xs text-muted leading-snug">{m.description}</div>
 </button>
 ))}
 </div>
 </div>
 ...
 <h2 className="font-serif text-xl font-bold text-ink mb-6">Your Prescription</h2>

 <div className="mb-5">
 <label className="block text-sm text-muted mb-2">Vial Strength</label>
 <div className="text-2xl font-bold text-ink">{med.vialSize} mg</div>
 <div className="text-xs text-faint mt-1">This is the total mg in your vial</div>
 </div>
 ...
 className="w-full bg-bg border border-line rounded-lg px-4 py-3 text-ink text-lg focus:border-accent focus:outline-none"
 />
 ...
 {/* Result */}
 <div className="bg-gradient-to-br rounded-xl p-6 border border-accent/50">
 <h2 className="font-serif text-xl font-bold text-accent mb-6">How Much to Draw</h2>

 {/* Big display */}
 <div className="text-center py-8 mb-6 bg-bg/60 rounded-xl border border-line">
 <div className="text-7xl font-bold text-ink mb-1">
 {calculations.unitsToDraw}
 </div>
 <div className="text-accent font-semibold tracking-widest uppercase text-sm">
 ...
 {/* Visual syringe */}
 <div className="mb-6">
 <div className="text-xs text-faint uppercase tracking-wider mb-2 text-center">
 Syringe Visual (U-100)
 </div>
 <div className="relative h-10 bg-bg rounded-full border border-line overflow-hidden mx-4">
 <div
 ...
 <span className="text-xs font-bold text-ink drop-shadow">
 {calculations.unitsToDraw} units
 </span>
 </div>
 </div>
 <div className="flex justify-between text-xs text-faint px-4 mt-1">
 <span>0</span>
 <span>25</span>
 <span>50</span>
 <span>75</span>
 ...
 {/* Confirmation */}
 <div className="p-4 bg-bg/60 rounded-lg border border-line text-center mb-4">
 <p className="text-muted text-sm">
 This gives you <span className="text-ink font-bold">{targetDose} mg</span> of {med.name}
 </p>
 ...
 {/* Reference Table */}
 <div className="mb-10 bg-surface rounded-xl p-6 border border-line">
 <h2 className="font-serif text-xl font-bold text-ink mb-2">Quick Reference Table</h2>
 ...
 >
 <div className="text-xs text-faint">{row.units}u</div>
 <div className="text-sm font-bold text-ink">{row.mg}</div>
 <div className="text-xs text-faint">mg</div>
 </div>
 ))}
 </div>
 </div>
 ...
 <div className="text-ink font-semibold text-sm mb-1">{tip.title}</div>
 <div className="text-muted text-xs leading-relaxed">{tip.detail}</div>
 </div>
 ))}
 </div>
 ...
 {/* CTA */}
 <div className="text-center p-8 bg-gradient-to-br to-[#13132a] border border-line rounded-2xl">
 ...
 <Link
 href="/contact"
 className="inline-block px-8 py-3 bg-accent text-[color:var(--on-accent)] font-semibold rounded tracking-wide hover:bg-accent-hover transition-colors"
 >
