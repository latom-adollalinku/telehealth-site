...
export default function SurgicalPreopPage() {
 ...
 <Link
 href="/book"
 className="px-8 py-4 bg-accent text-[color:var(--on-accent)] font-semibold rounded tracking-wide hover:bg-accent-hover transition-all duration-200 text-sm sm:text-base"
 >
 Schedule Consultation
 </Link>
 <Link
 href="#protocols"
 className="px-8 py-4 border border-accent text-accent font-semibold rounded tracking-wide hover:bg-accent hover:text-[color:var(--on-accent)] transition-all duration-200 text-sm sm:text-base"
 >
 Explore Protocols
 </Link>
 </div>
 ...
 <ScrollFade>
 <div className="bg-surface border border-line rounded-lg p-8 sm:p-12">
 <h2 className="text-3xl sm:text-4xl font-bold text-ink mb-8">Why Optimize Before Surgery?</h2>
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
 <div>
 <h3 className="text-accent font-semibold mb-3 text-lg">Reduce Complications</h3>
 ...
 <div>
 <h3 className="text-accent font-semibold mb-3 text-lg">Accelerate Recovery</h3>
 <p className="text-muted text-sm leading-relaxed">
 ...
 <div>
 <h3 className="text-accent font-semibold mb-3 text-lg">Optimize Anesthesia Safety</h3>
 <p className="text-muted text-sm leading-relaxed">
 ...
 <div>
 <h3 className="text-accent font-semibold mb-3 text-lg">Evidence-Based Approach</h3>
 <p className="text-muted text-sm leading-relaxed">
 ...
 <h2 className="text-4xl sm:text-5xl font-bold text-ink mb-6">Four Targeted Protocols</h2>
 ...
 <div className="bg-surface border border-line rounded-lg p-8 h-full flex flex-col">
 <div className="flex items-start justify-between mb-4">
 <div>
 <h3 className="text-2xl font-bold text-ink mb-2">{protocol.label}</h3>
 <span className={`inline-block px-3 py-1 rounded text-sm font-semibold text-ink ${protocol.badgeColor}`}>
 {protocol.badge}
 </span>
 </div>
 </div>

 <p className="text-accent font-semibold text-lg mb-3">{protocol.tagline}</p>
 <p className="text-muted text-sm mb-6 leading-relaxed">{protocol.description}</p>

 <div className="mb-6">
 <h4 className="text-ink font-semibold mb-3">Key Supplements:</h4>
 ...
 <li className="text-faint italic">+ {protocol.supplements.length - 5} more</li>
 )}
 </ul>
 </div>

 <div className="mb-6">
 <h4 className="text-ink font-semibold mb-3">Expected Outcomes:</h4>
 <ul className="text-muted text-sm space-y-2">
 ...
 <span className="font-semibold text-ink">Cost:</span> {protocol.cost}
 </p>
 <p className="text-muted text-sm">
 <span className="font-semibold text-ink">Duration:</span> {protocol.duration}
 </p>
 </div>
 </div>
 </ScrollFade>
 ...
 <ScrollFade>
 <div className="bg-surface border border-line rounded-lg p-8 sm:p-12">
 <h2 className="text-3xl sm:text-4xl font-bold text-ink mb-12 text-center">The Process</h2>

 <div className="space-y-8">
 <div className="flex gap-6">
 <div className="w-12 h-12 rounded-full bg-accent text-[color:var(--on-accent)] font-bold flex items-center justify-center flex-shrink-0">
 1
 </div>
 <div>
 <h3 className="text-ink font-semibold mb-2 text-lg">Initial Consultation</h3>
 <p className="text-muted text-sm leading-relaxed">
 ...
 <div>
 <h3 className="text-ink font-semibold mb-2 text-lg">Protocol Selection</h3>
 <p className="text-muted text-sm leading-relaxed">
 ...
 <div>
 <h3 className="text-ink font-semibold mb-2 text-lg">Amazon Shopping List</h3>
 <p className="text-muted text-sm leading-relaxed">
 ...
 <div>
 <h3 className="text-ink font-semibold mb-2 text-lg">Weekly Check-ins</h3>
 <p className="text-muted text-sm leading-relaxed">
 ...
 <div>
 <h3 className="text-ink font-semibold mb-2 text-lg">Pre-Op & Post-Op Support</h3>
 <p className="text-muted text-sm leading-relaxed">
 ...
 <ScrollFade>
 <div className="bg-surface border border-line rounded-lg p-8 sm:p-12">
 <h2 className="text-3xl sm:text-4xl font-bold text-ink mb-12">Safety & Surgical Guidelines</h2>

 <div className="space-y-8">
 {safetyChecklist.map((section, idx) => (
 <div key={idx}>
 <h3 className="text-accent font-semibold text-lg mb-4 uppercase tracking-wide">{section.category}</h3>
 <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
 {section.items.map((item, itemIdx) => (
 <li key={itemIdx} className="flex items-start gap-2 text-muted text-sm">
 ...
 <p className="text-muted text-sm">
 <span className="text-accent font-semibold">Important:</span> All protocols are designed to work safely with standard anesthetics. We communicate directly with your surgeon and anesthesia team about what you're taking.
 </p>
 </div>
 </div>
 </ScrollFade>
 ...
 <ScrollFade>
 <div className="bg-surface border border-line rounded-lg p-8 sm:p-12">
 <h2 className="text-3xl sm:text-4xl font-bold text-ink mb-6">Ready to Optimize?</h2>
 ...
 <Link
 href="/book"
 className="inline-block px-10 py-4 bg-accent text-[color:var(--on-accent)] font-semibold rounded tracking-wide hover:bg-accent-hover transition-all duration-200"
 >
