...
export default function LabsPage() {
 ...
 <div className="h-full flex flex-col bg-surface border border-line rounded-xl p-8 hover:border-accent/40 transition-all duration-300">
 <div className="flex items-center justify-between mb-4">
 <span className={`px-3 py-1 ${partner.badgeColor} text-ink text-xs font-bold rounded-full`}>
 {partner.badge}
 </span>
 <span className="font-serif text-2xl font-bold text-accent">{partner.price}</span>
 </div>

 <h3 className="font-serif text-2xl font-bold text-ink mb-1">{partner.name}</h3>
 <p className="text-accent text-xs mb-4">{partner.priceNote}</p>
 <p className="text-muted text-sm leading-relaxed mb-6">{partner.description}</p>
 ...
 <p className="text-xs text-faint mb-4">Best for: {partner.ideal}</p>
 ...
 : 'border border-accent text-accent hover:bg-accent hover:text-[color:var(--on-accent)]'
 }`}
 >
 {partner.cta}
 </a>
 ...
 <h3 className="font-serif text-xl font-semibold text-accent tracking-wider uppercase text-sm">
 {cat.category}
 </h3>
 <div className="h-px bg-accent/30 flex-1" />
 </div>
 ...
 <div
 key={i}
 className="bg-surface border border-line rounded-xl p-6 hover:border-line transition-all duration-200"
 >
 <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
 <div className="flex-1">
 <h4 className="text-ink font-semibold text-lg mb-1">{panel.name}</h4>
 <p className="text-muted text-sm mb-2">{panel.tests}</p>
 <p className="text-faint text-xs">When: {panel.when}</p>
 </div>
 <div className="text-right flex-shrink-0">
 <span className="font-serif text-xl font-bold text-accent">{panel.cost}</span>
 <p className="text-faint text-xs">estimated cost</p>
 </div>
 </div>
 </div>
 ))}
 ...
 target="_blank"
 rel="noopener noreferrer"
 className="inline-block px-8 py-4 bg-accent text-[color:var(--on-accent)] font-semibold rounded tracking-wide hover:bg-accent-hover transition-colors"
 >
 ...
 <div className="h-full bg-surface border border-line rounded-xl p-6 hover:border-accent/40 transition-all duration-300">
 <div className="text-3xl mb-3">{cat.icon}</div>
 <h3 className="text-ink font-semibold text-lg mb-2">{cat.name}</h3>
 <p className="text-muted text-sm leading-relaxed mb-3">{cat.description}</p>
 <p className="text-faint text-xs italic">{cat.examples}</p>
 </div>
 </ScrollFade>
 ))}
 </div>
 ...
 <h3 className="text-center text-accent text-xs tracking-widest uppercase font-medium mb-4">
 Brands We Carry
 </h3>
 ...
 <span
 key={i}
 className="px-4 py-2 bg-surface border border-line rounded text-muted text-sm"
 >
 {brand}
 </span>
 ))}
 ...
 target="_blank"
 rel="noopener noreferrer"
 className="inline-block px-8 py-4 bg-accent text-[color:var(--on-accent)] font-semibold rounded tracking-wide hover:bg-accent-hover transition-colors mb-3"
 >
 Open My Dispensary
 </a>
 <p className="text-faint text-xs max-w-xl mx-auto">
 ...
 <p className="font-serif text-3xl font-bold text-accent mb-6">$49.99</p>
 ...
 <p className="text-muted text-sm mb-3">Have elevated Lp(a), ApoB, or hs-CRP?</p>
 <Link
