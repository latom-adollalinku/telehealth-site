...
export default function MedicalBookingPage() {
 ...
 <ScrollFade>
 <div className="bg-[#111118] border border-line rounded-xl p-10">
 <div className="w-14 h-14 mx-auto mb-6 flex items-center justify-center rounded-full bg-accent-soft border border-line">
 ...
 <Link
 href="/"
 className="inline-block px-8 py-3 bg-accent text-[color:var(--on-accent)] font-semibold rounded tracking-wide hover:bg-accent-hover transition-colors duration-200"
 >
 Return to Home
 </Link>
 </div>
 ...
 <ScrollFade>
 <div className="bg-[#111118] border border-line rounded-xl p-8">
 ...
 <label htmlFor="state-select" className="block text-xs font-semibold text-accent uppercase tracking-wider mb-2">
 Your State
 </label>
 <select
 id="state-select"
 ...
 className="w-full px-4 py-3 rounded bg-bg border border-line text-ink focus:outline-none focus:border-accent/60 appearance-none cursor-pointer"
 >
 ...
 <Link
 href="/book/wellness"
 className="inline-block mt-3 px-5 py-2 bg-accent text-[color:var(--on-accent)] text-sm font-semibold rounded hover:bg-accent-hover transition-colors duration-200"
 >
 ...
 <div className="space-y-5 text-sm text-muted leading-relaxed mb-8">
 <div>
 ...
 className="mt-1 w-4 h-4 accent-[color:var(--accent)] cursor-pointer flex-shrink-0"
 />
 ...
 className="mt-6 w-full py-3 bg-accent text-[color:var(--on-accent)] font-semibold rounded tracking-wide hover:bg-accent-hover transition-colors duration-200"
 >
 ...
 className="w-full px-4 py-3 rounded bg-bg border border-line text-ink placeholder-gray-600 focus:outline-none focus:border-accent/60"
 />
 </div>
 ...
 onChange={handleFormChange}
 required
 className="w-full px-4 py-3 rounded bg-bg border border-line text-ink focus:outline-none focus:border-accent/60"
 />
 </div>
 ...
 readOnly
 className="w-full px-4 py-3 rounded bg-bg border border-line text-muted cursor-not-allowed"
 />
 </div>
 ...
 className="w-full px-4 py-3 rounded bg-bg border border-line text-ink placeholder-gray-600 focus:outline-none focus:border-accent/60 resize-vertical"
 />
 </div>
 ...
 <span className="normal-case text-faint font-normal">(optional)</span>
 </label>
 <input
 type="date"
 name="preferredDate"
 ...
 : 'bg-accent/30 text-[color:var(--on-accent)]/40 cursor-not-allowed'
 }`}
 >
