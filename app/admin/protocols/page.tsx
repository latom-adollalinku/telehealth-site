...
export default function AdminProtocols() {
 ...
 <h1 className="font-serif text-3xl font-bold text-ink">Protocols</h1>
 ...
 <div className="text-faint text-xs">{p.subtitle}</div>
 </td>
 <td className="px-4 py-3 text-accent font-medium">{p.price}</td>
 ...
 target="_blank"
 className="text-xs text-muted border border-line rounded px-2 py-1 hover:text-ink hover:border-gray-500"
 >
 View
 </Link>
 </td>
