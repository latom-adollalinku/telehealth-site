...
export default function AdminPaymentsPage() {
 ...
 <div>
 <h1 className="text-2xl font-bold text-ink">Payment Tracker</h1>
 <p className="text-muted text-sm mt-1">LATOM Wellness - Admin Dashboard</p>
 </div>
 <div className="flex items-center gap-3">
 <span className="text-xs text-faint bg-surface px-3 py-1 rounded-full border border-line">
 ...
 <p className="text-muted text-xs mb-1 uppercase tracking-wider">Pending</p>
 <p className="text-3xl font-bold text-yellow-400">{pendingCount}</p>
 </div>
 <div className="bg-surface border border-line rounded-lg p-5">
 <p className="text-muted text-xs mb-1 uppercase tracking-wider">Confirmed</p>
 <p className="text-3xl font-bold text-green-400">{paidCount}</p>
 </div>
 <div className="bg-surface border border-line rounded-lg p-5">
 <p className="text-muted text-xs mb-1 uppercase tracking-wider">Revenue logged</p>
 ...
 {/* Table header */}
 <div className="grid grid-cols-[1fr_1fr_1fr_120px_100px_140px] gap-4 px-6 py-3 bg-surface border-b border-line text-xs text-muted uppercase tracking-wider">
 <span>Patient</span>
 <span>Service</span>
 ...
 <div
 key={payment.id}
 className={`grid grid-cols-[1fr_1fr_1fr_120px_100px_140px] gap-4 px-6 py-4 border-b border-accent/5 items-center transition-colors ${
 payment.status === 'paid'
 ? 'bg-green-900/10'
 ...
 {/* Patient */}
 <div>
 <p className="text-ink font-medium text-sm">{payment.patientName}</p>
 <p className="text-faint text-xs">{payment.patientEmail}</p>
 <p className="text-faint text-xs mt-0.5">{payment.date}</p>
 </div>

 {/* Service */}
 <p className="text-muted text-sm">{payment.service}</p>

 {/* Booking ID */}
 <p className="text-muted text-xs font-mono">{payment.bookingId}</p>

 {/* Amount */}
 <p className="text-accent font-bold">${payment.amount}</p>
 ...
 />
 <span className="text-xs text-muted group-hover:text-gray-200 transition-colors">
 Received
 </span>
 </label>
 )}
 ...
 <span className="text-accent/70">Telehealth Payments</span> tab in your Google Sheet.
 </p>
 </div>
