...
function PayPageContent() {
 ...
 <p className="text-sm text-faint max-w-2xl mx-auto">
 ...
 <div className="mb-12">
 <h2 className="text-2xl font-bold text-ink mb-8 text-center">Choose Your Service Tier</h2>
 ...
 >
 <h3 className="text-xl font-bold text-ink mb-4">Standard Tier</h3>
 <p className="text-accent font-semibold text-lg mb-4">Most Affordable</p>
 ...
 <span className="px-3 py-1 bg-accent text-[color:var(--on-accent)] text-xs font-bold rounded-full">
 VIP EXPERIENCE
 </span>
 </div>
 <h3 className="text-xl font-bold text-ink mb-4 mt-4">Priority Tier</h3>
 <p className="text-accent font-semibold text-lg mb-4">Extended & Premium</p>
 <ul className="text-muted text-sm space-y-2 mb-6">
 ...
 {/* Service Selection */}
 <div className="mb-12">
 <h2 className="text-2xl font-bold text-ink mb-6 text-center">Select Service</h2>
 ...
 <p className="text-ink font-semibold">{service.name}</p>
 <p className="text-xs text-faint">{service.type === 'subscription' ? 'Monthly Subscription' : 'One-Time Payment'}</p>
 </div>
 ...
 <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
 <div className="mb-12">
 <h2 className="text-2xl font-bold text-ink mb-6 text-center">Choose Payment Method</h2>

 {/* Payment Summary */}
 <div className="bg-accent-soft border border-line rounded-lg p-6 mb-8">
 <div className="flex justify-between items-center">
 <div>
 <p className="text-muted text-sm mb-2">Selected Service</p>
 <p className="text-ink font-semibold text-lg">{selectedService.name}</p>
 </div>
 ...
 {/* Card Checkout */}
 <ScrollFade>
 <form onSubmit={handleCheckout} className="bg-surface border border-line rounded-lg p-6 sm:p-8 space-y-4">
 <div className="mb-2">
 <h3 className="font-serif text-xl font-bold text-ink mb-1">Checkout</h3>
 <p className="text-muted text-sm">Enter your details to continue to secure card payment.</p>
 </div>
 ...
 required
 autoComplete="name"
 className="w-full px-4 py-3 bg-bg border border-line rounded text-ink text-sm focus:outline-none focus:border-accent"
 />
 <input
 type="tel"
 placeholder="Phone"
