...
export default function CardiovascularLipidEducationPage() {
 ...
 <h2 className="font-serif text-2xl font-bold text-ink mb-4">Who This Education Is For</h2>
 <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
 <div>
 <p className="text-red-400 font-semibold text-sm mb-1">HDL Below Target</p>
 <p className="text-muted text-sm">HDL is suboptimal and your physician has not addressed lifestyle or supplement strategies.</p>
 </div>
 <div>
 <p className="text-red-400 font-semibold text-sm mb-1">ApoB Above 100</p>
 <p className="text-muted text-sm">Atherogenic particle count is elevated. ApoB is a stronger cardiovascular predictor than LDL alone.</p>
 </div>
 <div>
 <p className="text-amber-400 font-semibold text-sm mb-1">Incomplete Lab Panel</p>
 <p className="text-muted text-sm">Your provider checks basic labs but does not order ApoB, Lp(a), or hs-CRP. You need the full picture.</p>
 </div>
 </div>
 </div>
 </ScrollFade>
 ...
 <p className="text-muted">Expected lipid improvements in 8-12 weeks with consistent lifestyle and supplement implementation.</p>
 </div>
 </ScrollFade>
 ...
 <p className="text-muted">All Amazon-accessible. No prescription needed for the supplement layer.</p>
 </div>
 </ScrollFade>
 ...
 <h3 className="font-serif text-2xl font-bold text-ink mb-4">Why Your Lipids Got Worse on TRT</h3>
 ...
 <ScrollFade>
 <div className="bg-surface border border-line rounded-xl p-8">
 <h3 className="font-serif text-2xl font-bold text-ink mb-4">Lifestyle Requirements</h3>
 <ul className="space-y-3 text-muted text-sm">
 <li><strong className="text-accent">Blood donation quarterly:</strong> Manages hematocrit if TRT pushes it above 52%. Non-negotiable for CV protection.</li>
 <li><strong className="text-accent">Zone 2 cardio 3x/week:</strong> Single highest HDL-raising intervention. 45-60 min sessions.</li>
 <li><strong className="text-accent">Limit saturated fat:</strong> Under 10% of calories. Trade butter/cheese for olive oil and nuts.</li>
 <li><strong className="text-accent">Track HRV:</strong> Whoop or Oura. TRT can affect sympathetic tone. Early warning signal.</li>
 <li><strong className="text-accent">Keep TRT dose moderate:</strong> Supra-physiologic doses worsen lipids. Stay in upper-physiologic range (700-1000 ng/dL total T).</li>
 </ul>
 </div>
 </ScrollFade>
 </div>
 ...
 <span className="font-serif text-2xl font-bold text-accent">$114-176</span>
 </div>
 </div>
 </div>
 </ScrollFade>
 ...
 <ul className="space-y-3 text-muted text-sm">
 <li><strong className="text-ink">Niacin titration:</strong> Start 500mg, increase every 2 weeks. Flushing common first week. Take with food. Monitor liver enzymes after 6-8 weeks.</li>
 <li><strong className="text-ink">Don&apos;t stop TRT abruptly:</strong> Exogenous testosterone suppresses natural production. Stopping without physician guidance causes HPTA crash.</li>
 <li><strong className="text-ink">If already on a statin:</strong> CoQ10 is mandatory, not optional. Statins deplete CoQ10 and cause muscle symptoms.</li>
 <li><strong className="text-ink">Recheck labs:</strong> Full lipid panel + ApoB + hs-CRP at 12 weeks.</li>
 </ul>
 </div>
 </ScrollFade>
 </div>
 ...
 <h2 className="font-serif text-2xl font-bold text-ink mb-4">Want Your Labs Reviewed?</h2>
 <p className="text-muted mb-6">Upload your TRT panel + lipid panel for a physician review and personalized adjustments.</p>
