...
export default function SleepProtocolPage() {
 ...
 <ScrollFade>
 <div className="bg-surface border border-indigo-500/30 rounded-xl p-8">
 ...
 <p className="text-muted text-sm">Racing mind, &gt;20 min to sleep onset, bedtime anxiety, rumination.</p>
 </div>
 <div>
 <p className="text-indigo-400 font-semibold text-sm mb-1">Wake Through the Night</p>
 <p className="text-muted text-sm">3 AM wakeups, frequent disruptions, unable to return to sleep.</p>
 </div>
 <div>
 <p className="text-indigo-400 font-semibold text-sm mb-1">Not Recovering</p>
 <p className="text-muted text-sm">Low HRV, low deep sleep %, waking unrefreshed despite 8 hrs in bed.</p>
 </div>
 </div>
 </div>
 </ScrollFade>
 ...
 <ScrollFade>
 <div className="text-center mb-12">
 <h2 className="font-serif text-4xl font-bold text-ink mb-4">Sleep Stack Timing</h2>
 <p className="text-muted max-w-xl mx-auto">Timing matters more than total dose. Each phase is designed for a specific sleep architecture window.</p>
 </div>
 </ScrollFade>
 ...
 <ScrollFade>
 <div className="bg-surface border border-line rounded-xl p-8">
 <h3 className="font-serif text-2xl font-bold text-ink mb-4">Sleep Hygiene (Non-Negotiable)</h3>
 <p className="text-muted text-sm mb-6">
 Supplements amplify good habits. Fix these first, or supplements will waste money:
 </p>
 <ul className="space-y-3 text-muted text-sm">
 <li><strong className="text-accent">Consistent wake time:</strong> Same time every day, including weekends. Anchors your circadian rhythm.</li>
 <li><strong className="text-accent">Morning sunlight:</strong> 10-15 min within 30 min of waking. Sets melatonin clock for 16 hours later.</li>
 <li><strong className="text-accent">Last caffeine by noon:</strong> 6-hour half-life - 3 PM coffee is still active at 9 PM.</li>
 <li><strong className="text-accent">Cool bedroom:</strong> 65-68°F ideal. Core body temp must drop to initiate deep sleep.</li>
 <li><strong className="text-accent">Blackout curtains + no screens 60 min pre-bed:</strong> Even dim light suppresses melatonin 50%.</li>
 <li><strong className="text-accent">No alcohol within 3 hours of bed:</strong> Destroys REM sleep. Single biggest modifiable factor.</li>
 <li><strong className="text-accent">Eating window closes 3 hrs pre-bed:</strong> Digestion blocks sleep-related cooling and hormone cycles.</li>
 </ul>
 </div>
 </ScrollFade>
 </div>
 ...
 <ScrollFade>
 <div className="bg-surface border border-line rounded-xl p-8">
 <h3 className="font-serif text-2xl font-bold text-ink mb-4">Tracking: Measure What You&apos;re Fixing</h3>
 <p className="text-muted text-sm mb-4">
 You cannot optimize what you don&apos;t measure. Pick one:
 </p>
 <ul className="space-y-3 text-muted text-sm">
 <li><strong className="text-accent">Whoop ($30/mo):</strong> Best for HRV, sleep stages, recovery scoring. Worn 24/7.</li>
 <li><strong className="text-accent">Oura Ring ($299 + $6/mo):</strong> Best for sleep architecture + readiness. Comfortable to wear.</li>
 <li><strong className="text-accent">8Sleep Pod ($2-4k):</strong> Thermal regulation + tracking in one. Actively cools/warms.</li>
 <li><strong className="text-accent">Apple Watch:</strong> Good enough if you already have one. Focus on &ldquo;Time in Deep Sleep.&rdquo;</li>
 </ul>
 </div>
 </ScrollFade>
 </div>
 ...
 <span className="font-serif text-2xl font-bold text-accent">$100–155</span>
 </div>
 <div className="flex items-center justify-between px-6 py-4 bg-bg">
 <span className="text-ink font-semibold">With Peptides</span>
 <span className="font-serif text-2xl font-bold text-accent">$200–455</span>
 </div>
 </div>
 </div>
 </ScrollFade>
 ...
 <ul className="space-y-3 text-muted text-sm">
 <li><strong className="text-ink">Melatonin dosing:</strong> Low dose (0.3-1 mg) - NOT the 3-10 mg OTC pills. Higher doses desensitize receptors and cause morning grogginess.</li>
 <li><strong className="text-ink">Ashwagandha + thyroid:</strong> Can affect thyroid hormone levels - monitor TSH if hypothyroid.</li>
 <li><strong className="text-ink">DSIP prescription:</strong> Requires physician consultation. Not for use in pregnancy, bleeding disorders, or acute illness.</li>
 <li><strong className="text-ink">Sleep apnea screen first:</strong> If symptoms (loud snoring, witnessed pauses, daytime sleepiness), get a home sleep test. Supplements will not fix apnea.</li>
 <li><strong className="text-ink">Rebound insomnia:</strong> Do not stop melatonin abruptly after &gt;2 weeks. Taper down by 50% over 1 week.</li>
 </ul>
 </div>
 </ScrollFade>
 </div>
 ...
 <h2 className="font-serif text-2xl font-bold text-ink mb-4">Want DSIP or Pineal Peptides?</h2>
 <p className="text-muted mb-6">DSIP, Epitalon, and Pinealon require a physician consultation. Book one to discuss whether they&apos;re right for your sleep issues.</p>
