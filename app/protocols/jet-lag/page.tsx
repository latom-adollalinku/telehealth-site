...
export default function JetLagProtocolPage() {
 ...
 <ScrollFade>
 <div className="text-center mb-12">
 <h2 className="font-serif text-4xl font-bold text-ink mb-4">3-Phase Protocol</h2>
 </div>
 </ScrollFade>
 ...
 <h3 className="font-serif text-2xl font-bold text-ink mb-4">Direction Rules</h3>
 ...
 <li><strong className="text-accent">Eastbound (US → Europe):</strong> Start shifting bedtime 1 hour earlier for 3 nights pre-trip. Take melatonin at new bedtime. Morning light on arrival.</li>
 <li><strong className="text-accent">Westbound (US → Asia):</strong> Stay up later 3 nights pre-trip. Afternoon/evening light on arrival. Delay melatonin.</li>
 <li><strong className="text-accent">Short trips (&lt;3 days):</strong> Don&apos;t shift. Stay on home time. Not worth the effort.</li>
 <li><strong className="text-accent">Fasting hack:</strong> 16-hour fast ending with breakfast in destination timezone. Food timing entrains circadian strongly.</li>
 </ul>
 </div>
 </ScrollFade>
 </div>
 ...
 <ul className="space-y-3 text-muted text-sm">
 <li><strong className="text-ink">Melatonin dose matters:</strong> 0.3-1 mg is circadian signaling. 3-10 mg is sedation. You want the signal, not the knockout.</li>
 <li><strong className="text-ink">Don&apos;t drink on the flight:</strong> Alcohol dehydrates + fragments sleep. Worst jet lag amplifier.</li>
 <li><strong className="text-ink">Skip sleeping pills:</strong> Zolpidem or benzos at altitude can cause confusional states. Use natural sleep aids only.</li>
 <li><strong className="text-ink">Caffeine timing:</strong> Only use caffeine in destination morning. Never after 2 PM destination time.</li>
 </ul>
 </div>
 </ScrollFade>
 </div>
