    ...
    <>
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollFade>
            <div className="bg-[#1a1a2e] border border-emerald-500/30 rounded-xl p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  <h3 className="text-[#c9a84c] text-sm tracking-widest uppercase font-medium mb-3">Supplement Protocols by Pattern</h3>
                  ...
                  <h3 className="text-[#c9a84c] text-sm tracking-widest uppercase font-medium mt-6 mb-3">Prescription Options</h3>
                  <ul className="space-y-2">
