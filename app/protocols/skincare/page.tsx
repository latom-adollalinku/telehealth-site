...
export default function SkincareProtocolPage() {
 ...
 <h2 className="font-serif text-2xl font-bold text-ink mb-4">The 4 Ingredients That Actually Work</h2>
 ...
 <div key={idx} className="bg-bg border border-line rounded p-4">
 <p className="text-accent font-semibold mb-1">{i.name}</p>
 <p className="text-muted text-sm">{i.evidence}</p>
 </div>
 ))}
 </div>
 </div>
 ...
 <ScrollFade>
 <div className="text-center mb-12">
 <h2 className="font-serif text-4xl font-bold text-ink mb-4">Daily Routine</h2>
 </div>
 </ScrollFade>
 ...
 {item.dose && <span className="text-accent text-xs font-mono">{item.dose}</span>}
 </div>
 ...
 <ScrollFade>
 <div className="bg-surface border border-line rounded-xl p-8">
 <h3 className="font-serif text-2xl font-bold text-ink mb-4">Weekly Additions (Optional)</h3>
 <div className="space-y-3">
 {weeklyAdditions.map((item, i) => (
 <div key={i} className="flex items-start justify-between gap-3 p-3 bg-bg border border-line rounded">
 <div>
 <p className="text-ink font-semibold text-sm">{item.name}</p>
 <p className="text-faint text-xs">{item.target}</p>
 </div>
 <span className="text-accent font-mono text-xs flex-shrink-0">{item.dose}</span>
 </div>
 ))}
 </div>
 </div>
 ...
 <ScrollFade>
 <div className="bg-surface border border-line rounded-xl p-8">
 <h3 className="font-serif text-2xl font-bold text-ink mb-4">Retinol Ramp-Up Schedule</h3>
 <p className="text-muted text-sm mb-4">
 Retinol irritation is the #1 reason people quit. Ramp slowly.
 </p>
 <ul className="space-y-3 text-muted text-sm">
 <li><strong className="text-accent">Weeks 1-2:</strong> Retinol 0.3% - 2x/week, pea-sized amount, on moisturized skin</li>
 <li><strong className="text-accent">Weeks 3-4:</strong> Increase to 3x/week</li>
 <li><strong className="text-accent">Weeks 5-8:</strong> Every other night</li>
 <li><strong className="text-accent">Weeks 9+:</strong> Nightly if tolerating. Can increase to 0.5% or 1%.</li>
 <li><strong className="text-accent">Prescription upgrade:</strong> Tretinoin 0.025%-0.1% - stronger and better studied. Requires physician.</li>
 </ul>
 </div>
 </ScrollFade>
 </div>
 ...
 <h3 className="text-ink font-semibold">Total Cost (Entire Routine)</h3>
 </div>
 ...
 <span className="text-ink font-semibold">Total - Entire 3-Month Routine</span>
 <span className="font-serif text-2xl font-bold text-accent">~$102</span>
 </div>
 </div>
 </div>
 </ScrollFade>
 ...
 <ul className="space-y-3 text-muted text-sm">
 <li><strong className="text-ink">Don&apos;t combine same night:</strong> Vitamin C + Retinol. Or Retinol + AHA/BHA. Alternate nights.</li>
 <li><strong className="text-ink">Retinol + sun:</strong> Retinol thins the outer skin layer - always wear SPF the next day.</li>
 <li><strong className="text-ink">Pregnancy/nursing:</strong> No retinol or tretinoin. Stick to Vitamin C and SPF.</li>
 <li><strong className="text-ink">Sensitive skin:</strong> Start with retinol 0.1% or skip retinol and use peptides instead.</li>
 <li><strong className="text-ink">Everything else is optional:</strong> You can get 80% of benefits from these 4 ingredients. Don&apos;t fall for $400 serums.</li>
 </ul>
 </div>
 </ScrollFade>
 </div>
