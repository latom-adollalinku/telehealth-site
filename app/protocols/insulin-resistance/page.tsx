...
export default function InsulinResistanceProtocolPage() {
 ...
 <div>
 <h3 className="text-accent text-sm tracking-widest uppercase font-medium mb-3">Fiber Stack</h3>
 ...
 <h3 className="text-accent text-sm tracking-widest uppercase font-medium mb-3">Plant Compounds</h3>
 <ul className="space-y-2 mb-4">
 ...
 <h3 className="text-accent text-sm tracking-widest uppercase font-medium mb-3">Natural Insulin-Sensitivity Boosters</h3>
 <ul className="space-y-2 mb-4">
 ...
 <h3 className="text-accent text-sm tracking-widest uppercase font-medium mb-3">Prescription Options</h3>
 ...
 <h3 className="font-serif text-2xl font-bold text-ink mb-4">Lifestyle Protocol Stack</h3>
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
 <div>
 <p className="text-accent text-sm tracking-widest uppercase font-medium mb-3">Time-Restricted Eating</p>
 ...
 <div>
 <p className="text-accent text-sm tracking-widest uppercase font-medium mb-3">Exercise Sequencing</p>
 <ul className="space-y-2 text-muted text-sm">
 ...
 <div>
 <p className="text-accent text-sm tracking-widest uppercase font-medium mb-3">Sleep Protocol</p>
 <ul className="space-y-2 text-muted text-sm">
 ...
 <div>
 <p className="text-accent text-sm tracking-widest uppercase font-medium mb-3">Meal Construction</p>
 <ul className="space-y-2 text-muted text-sm">
 ...
 <ScrollFade>
 <div className="bg-surface border border-line rounded-xl p-8">
 <h3 className="font-serif text-2xl font-bold text-ink mb-2">Prescription Tier: GLP-1 Agonists</h3>
 ...
 <p className="text-accent font-semibold text-sm mb-3">Semaglutide (Ozempic / Wegovy)</p>
 <ul className="space-y-1.5 text-muted text-xs">
 <li><span className="text-ink">Start:</span> 0.25 mg SC weekly x4 weeks</li>
 <li><span className="text-ink">Titration:</span> 0.5 mg, 1 mg, 1.7 mg, 2.4 mg q4 weeks</li>
 <li><span className="text-ink">IR benefit:</span> HOMA-IR reduction 1.2-2.4 points at 6 months</li>
 <li><span className="text-ink">Monitoring:</span> Fasting insulin + HOMA-IR at 12 weeks</li>
 <li><span className="text-ink">Contraindications:</span> MTC/MEN2 personal or family history</li>
 </ul>
 </div>
 <div className="bg-surface rounded-lg p-5 border border-line">
 <p className="text-accent font-semibold text-sm mb-3">Tirzepatide (Mounjaro / Zepbound)</p>
 <ul className="space-y-1.5 text-muted text-xs">
 <li><span className="text-ink">Start:</span> 2.5 mg SC weekly x4 weeks</li>
 <li><span className="text-ink">Titration:</span> 5 mg, 7.5 mg, 10 mg, 12.5 mg, 15 mg q4 weeks</li>
 <li><span className="text-ink">IR benefit:</span> Superior insulin sensitization vs. semaglutide (dual GIP/GLP-1)</li>
 <li><span className="text-ink">PCOS note:</span> Preferred agent for IR in PCOS - GIP component improves ovarian insulin signaling</li>
 <li><span className="text-ink">Monitoring:</span> Same as semaglutide + LH/FSH in PCOS</li>
 </ul>
 </div>
 </div>
 <div className="bg-surface rounded-lg p-5 border border-line mb-4">
 <p className="text-accent font-semibold text-sm mb-3">Metformin as Bridge Therapy</p>
 ...
 <li><strong className="text-ink">Berberine + GLP-1:</strong> Do not start both simultaneously at full dose. Begin berberine first for 4 weeks, then initiate GLP-1 at lowest dose with glucose monitoring.</li>
 <li><strong className="text-ink">CGM strongly recommended:</strong> Dexcom Stelo (OTC) or Abbott Lingo gives real-time feedback on intervention effectiveness. Non-negotiable in HOMA-IR above 3.</li>
 <li><strong className="text-ink">Gallbladder risk:</strong> GLP-1 agonists slow gallbladder motility. Rapid weight loss on GLP-1 increases cholesterol gallstone risk. Consider ursodiol 300mg BID prophylactically if rapid weight loss occurs.</li>
 <li><strong className="text-ink">Recheck schedule:</strong> Labs at 12 weeks (fasting insulin, HOMA-IR, HbA1c, ApoB, liver enzymes). Adjust protocol based on results.</li>
 </ul>
 </div>
 </ScrollFade>
 </div>
