...
const labelBase = 'block text-sm font-medium text-muted mb-2';
const inputBase =
 'w-full px-4 py-3 bg-bg border border-line rounded text-ink focus:outline-none focus:border-accent transition';
...
function RadioGroup(props: {
 ...
 : 'bg-bg border-line text-muted hover:border-accent/60'
 }`}
 >
 <input
 type="radio"
...
function Slider(props: {
 ...
 <label className="text-sm font-medium text-muted">{props.label}</label>
 <span className="text-accent font-semibold text-lg tabular-nums">{props.value}</span>
 </div>
 <input
 type="range"
 name={props.name}
 ...
 className="w-full h-2 rounded-lg appearance-none cursor-pointer bg-bg border border-line accent-[color:var(--accent)]"
 />
...
export default function PatientIntakePage() {
 ...
 <br />
 <span className="text-accent">All responses are confidential.</span>
 </p>
 </div>
 </section>
 ...
 <div className="w-14 h-14 mx-auto mb-6 rounded-full bg-accent-soft border border-line flex items-center justify-center">
 <span className="text-accent text-2xl">✓</span>
 </div>
 <h2 className="text-2xl font-bold text-ink mb-3">Thank you, {patientName.split(' ')[0] || 'there'}.</h2>
 <p className="text-muted mb-6">
 Your intake has been received. Dr. Abdul will review your responses before your consultation.
 A confirmation has been sent to <span className="text-accent">{patientEmail}</span>.
 </p>
 <div className="flex flex-col sm:flex-row gap-3 justify-center">
 <a
 href="/book"
 className="px-6 py-3 bg-accent text-[color:var(--on-accent)] font-semibold rounded hover:bg-accent-hover transition"
 >
 Book a Consultation
 </a>
 <button
 ...
 className="px-6 py-3 border border-accent/40 text-accent font-semibold rounded hover:bg-accent-soft transition"
 >
 Submit Another
 </button>
 </div>
 ...
 {/* Progress */}
 <div className="flex items-center justify-between bg-surface border border-line rounded-lg px-5 py-3">
 <div className="text-xs uppercase tracking-wider text-faint">
 Step {currentStep} of {totalSteps}
 </div>
 <div className="flex-1 mx-4 h-1 rounded bg-bg overflow-hidden">
 <div
 ...
 <h2 className="text-xl font-bold text-ink mb-2">1. Which service is this for?</h2>
 ...
 : 'bg-bg border-line hover:border-accent/60'
 }`}
 >
 ...
 className="accent-[color:var(--accent)] w-4 h-4"
 />
 <span className={`font-semibold text-sm ${active ? 'text-ink' : 'text-gray-200'}`}>
 {s.label}
 </span>
 </div>
 <p className="text-xs text-faint ml-7">{s.tagline}</p>
 </label>
 );
 })}
 </div>
 ...
 <div className="bg-surface border border-line rounded-lg p-6 sm:p-8">
 <h2 className="text-xl font-bold text-ink mb-2">2. Your contact info</h2>
 <p className="text-muted text-sm mb-6">
 ...
 type="submit"
 disabled={submitting}
 className="w-full py-4 bg-accent text-[color:var(--on-accent)] font-semibold rounded tracking-wide hover:bg-accent-hover transition-colors duration-200 disabled:opacity-60 disabled:cursor-not-allowed"
 >
